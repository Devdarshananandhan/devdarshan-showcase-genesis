        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 mt-8">
            ...
            <p className="text-lg">
              ...
              mobile development. I'm also proficient in UI/UX design using Figma,
          ...
          <div className="mt-10 pt-10 border-t border-border">
            ...
            <div className="space-y-6">
              <div className="card-hover p-6 rounded-lg border border-border bg-card">
                <h4 className="font-bold text-lg">Bachelor of Technology in Computer Science</h4>
                <p className="text-primary mb-2">2018 - 2022</p>
                <p className="text-muted-foreground">
                  Prestigious Technical University, with focus on algorithms, data structures,
